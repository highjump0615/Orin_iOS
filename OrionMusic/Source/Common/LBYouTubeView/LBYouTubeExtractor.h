...
@interface LBYouTubeExtractor : NSObject<UIWebViewDelegate>
{
    UIWebView           *webVW;
    NSString            *encrSygback;
    NSMutableString     *streamURLback;
    NSString            *strPrefix;
}
...
@property (nonatomic, assign) IBOutlet id <LBYouTubeExtractorDelegate> delegate;
